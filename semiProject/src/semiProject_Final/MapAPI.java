...
public class MapAPI {
	...
	//찾기
	public List<PlaceVO> searchTruckApi(List<PlaceVO> pvl, String myAddr){
		...
		try {
			for(PlaceVO vo: pvl) {
				...
				double dist = distance(Double.parseDouble(myX),Double.parseDouble(myY),
						Double.parseDouble(truckX),Double.parseDouble(truckY));
